...
import 'Forum.dart';
import 'Home.dart';
import 'Persisenttabbottom.dart';
import 'Profile.dart';
        ...
        builder: (context,snapshot){
          return ListView(
            children: [
              ...
              Center(
                child: Text(
                  'Sign in', style: GoogleFonts.poppins(fontSize: 30,
                  ...
                  children: [
                    ...
                    ElevatedButton(onPressed: () async{
                      if(_formKey.currentState!.validate()){
                        ...
                        if(user !=null){
                          Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context)=>PersistentTabsDemo()));
                        }
                      }
                    },
